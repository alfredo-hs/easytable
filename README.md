...
[![License: MIT](https://img.shields.io/badge/license-MIT-yellow.svg)](LICENSE) [![pkgdown](https://img.shields.io/badge/pkgdown-site-blue)](https://alfredo-hs.github.io/easytable/) [![r-universe version](https://alfredo-hs.r-universe.dev/easytable/badges/version)](https://alfredo-hs.r-universe.dev/easytable) [![r-universe status](https://alfredo-hs.r-universe.dev/easytable/badges/checks)](https://alfredo-hs.r-universe.dev/easytable) [![R-CMD-check](https://github.com/alfredo-hs/easytable/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/alfredo-hs/easytable/actions/workflows/R-CMD-check.yaml)
...
This is the development version of `easytable`.

``` r
install.packages(
  "easytable",
  repos = c("https://alfredo-hs.r-universe.dev",
