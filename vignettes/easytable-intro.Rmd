...
### HTML Output (via Word renderer)

For Quarto and R Markdown HTML/PDF documents, use the default Word renderer (`flextable`), which also prints to HTML:
...
- Interpretation: unit change in X → change in E[Y]
...
You can export both a Word table and the underlying CSV table:
...
|--------|----------|------|------|
| **Word/HTML** | MS Word docs, Quarto/RMarkdown HTML | Beautiful formatting, easy to customize | Requires flextable |
...
- Check [GitHub](https://github.com/alfredo-hs/easytable) for latest updates
