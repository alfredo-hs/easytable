...
test_that("format_markdown creates character output", {
  skip_if_not_installed("knitr")

  parsed <- parse_models(test_single_model, robust.se = FALSE, margins = FALSE)
  transformed <- transform_table(parsed, control.var = NULL)

  result <- format_markdown(transformed, robust.se = FALSE, margins = FALSE, highlight = FALSE)
...
test_that("format_markdown includes significance footnote", {
  skip_if_not_installed("knitr")
...
test_that("format_markdown adds method notes", {
  skip_if_not_installed("knitr")
  skip_if_not_installed("lmtest")
  skip_if_not_installed("sandwich")
  ...
  result <- format_markdown(transformed, robust.se = TRUE, margins = FALSE, highlight = FALSE)
